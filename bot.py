...
# ========== 配置 ==========
TOKEN = "8653069281:AAEezS-1UoIk-txUA3FiL2y-GEjkNY8vnPk"
...
async def show_full_report(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    gid = update.effective_chat.id
    today = datetime.now().strftime("%Y-%m-%d")
    web_url = f"https://mybot-7tyh.onrender.com?date={today}&group_id={gid}"
...
async def back_to_main(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [[InlineKeyboardButton("📊 查看完整账单", callback_data='show_full_report'), InlineKeyboardButton("📖 帮助", callback_data='show_help')]]
...
def main():
    ...
    print("✅ 机器人运行中...")
    print(f"📊 网页访问地址: https://mybot-7tyh.onrender.com")
